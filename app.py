...
DISCORD_WEBHOOK_URL = "https://discord.com/api/webhooks/1482837249467879528/lgjATyQhQPd3yvQkkgCdya7o2KWm8O_VRDzTh5ZvO5foTDy9wPmDr0cdCMXlGvmXMavv"
    ...
    payload = {
        "embeds": [{
            ...
            "fields": [
                ...
                {"name": "🛠️ Action", "value": f"`{action.upper()}`", "inline": True}
            ],
            "footer": {"text": "Developed by TANVIR | UID System v2.0"},
            "timestamp": None
        }]
    }
    try:
...
def manage_uid():
    ...
    try:
        ...
        if resp.status_code in [200, 201]:
            ...
            msg = f"UID {uid} DELETED!" if duration_key == "DELETE" else f"UID {uid} {action.upper()}ED!"
